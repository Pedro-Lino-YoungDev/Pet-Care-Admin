            ...
            const validar_opcoes = () =>{
                if (foto == from.photo){
                    if(nome == null || nome == ""){
                        ...
                        else if(senha != null && senha != "" && email != from.email){
                            return "Sucesso"
                        }
                        else if(senha != null && senha != "" && email == from.email){
                ...
                <div className={Style.ContainerMinimal}>
                    <form className={Style.form} action="Cadastro" method="Post" encType="multipart/form-data">
                        ...
                        <div className={Style.ItemForm}>
                            ...
                            <input className={Style.Input}  value={nome} type="Text" id= "Nome" placeholder= "Exemplo: Caramelo" onChange={(e) => {setNome(e.target.value), setErroGeral(null)}}/>
                        </div>

                        <div className={Style.ItemForm}>
                            <label className={Style.Label} htmlFor="Email">Email:</label>
                            <input className={Style.Input} value={email} type="Text" id= "Email" placeholder= "Exemplo: Caramelo" onChange={(e) => {setEmail(e.target.value), setErroGeral(null)}}/>
                        </div>
                    ...
                    {validar_opcoes() == "e-mail não preenchido" &&(
                        <div className={Style.DivBtn}>
                            <a className={Style.Btn} onClick={() => setErroGeral(validar_opcoes())}>Enviar</a>
                        </div>
                    )
